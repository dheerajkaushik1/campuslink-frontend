...
export default function Syllabus() {
    ...
    return (
        <>
            <SEO
                title="College Syllabus - CampusLink"
                description="Browse college syllabus and subject-wise academic information on CampusLink."
                path="/syllabus"
            />
                        ...
                        <>
                            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                                {paginatedSyllabi.map((syllabus) => (
                                    ...
                                    >
                                        <ResourceVisual kind="syllabus" compact />
