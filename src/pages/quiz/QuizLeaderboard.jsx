...
export default function QuizLeaderboard() {
  ...
  return (
    <>
      <SEO
        title="Quiz Leaderboard - CampusLink"
        description="See the top performers on the CampusLink quiz leaderboard."
      ...
      <QuizModuleShell className="pb-12 pt-8">
        ...
        {loading ? (
          ...
          <>
            <section className="relative z-10 grid gap-4 overflow-visible text-white lg:grid-cols-3">
              {topThree[1] && (
                <PodiumCard
                  entry={topThree[1]}
